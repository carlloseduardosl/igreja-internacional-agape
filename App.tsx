      ...
      <main className="flex-grow pt-14">
        ...
        {activeSection === 'home' && (
          <section className="animate-fadeIn">
            ...
            {/* SEÇÃO: Ágape TV - Transmissão ao Vivo (Mobile Optimized) */}
            <div className="py-16 px-4 md:px-6 bg-white overflow-hidden">
              <div className="max-w-5xl mx-auto">
                ...
                {/* Container do Player - Responsividade Máxima */}
                <div className="relative w-full max-w-4xl mx-auto rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl bg-black ring-1 ring-gray-100 group">
                ...
                {/* Botão de segurança para dispositivos com restrição de embed */}
                <div className="mt-8 text-center px-4">
                  <p className="text-gray-400 text-[9px] md:text-[10px] uppercase tracking-widest mb-4 leading-relaxed">
                    Problemas com o player? Algumas redes ou dispositivos bloqueiam vídeos incorporados.
                  </p>
                  <a 
        ...
        {/* Demais Abas - Renderização Condicional para evitar espaço vazio */}
        {activeSection !== 'home' && (
                    ...
                    {filteredCells.map((cell) => (
                      <div key={cell.id} className="p-6 bg-white border border-gray-100 rounded-3xl flex flex-col justify-between hover:shadow-lg transition-all border-b-4 border-b-agape-red/5 hover:border-b-agape-red relative overflow-hidden">
                        ...
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="w-full bg-[#25D366] text-white py-4 rounded-2xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 shadow-sm active:scale-95"
                        >
              ...
              <div className="animate-fadeIn max-w-2xl mx-auto">
                ...
                {bookingSuccess ? (
                  ...
                  <form onSubmit={handleSubmitBooking} className="space-y-6 bg-gray-50 p-8 sm:p-10 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <button type="submit" disabled={isSendingBooking} className="w-full bg-agape-red text-white py-5 rounded-xl font-bold text-xs uppercase tracking-[0.2em] shadow-lg shadow-red-900/10 hover:bg-red-700 active:scale-95 transition-all disabled:opacity-50">
              ...
              <div className="animate-fadeIn max-w-xl mx-auto text-center">
                ...
                <div className="bg-gray-50 p-8 sm:p-12 rounded-3xl border border-gray-100 shadow-sm">
                  ...
                  <button 
                    ...
                    className="w-full bg-agape-red text-white py-5 rounded-2xl font-bold text-xs uppercase tracking-[0.2em] shadow-lg active:scale-95 transition-all disabled:opacity-50"
                  >
                    Gerar Código PIX
                  </button>
                    ...
                    <div className="mt-10 p-8 bg-white border-2 border-dashed border-gray-200 rounded-2xl animate-slideIn">
                      ...
                      <div className="flex flex-col gap-3">
                        <button 
                          ...
                          className="w-full bg-agape-red text-white py-4 rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-md hover:bg-red-700 transition-all flex items-center justify-center gap-2 active:scale-95"
                        >
