          ...
          {activeSection === 'cells' && (
            <div className="animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {CELLS_DATA.map((cell) => (
                  <div key={cell.id} className="p-6 bg-gray-50 border border-gray-100 rounded-xl flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="mt-2 w-full bg-[#25D366] text-white py-3 rounded-lg font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#128C7E] transition-colors"
                    >
